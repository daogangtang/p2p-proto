...
const MAIN_TOPIC: &str = "consensus_node";
const SIDE_TOPIC: &str = "readonly_node";
...
fn main() {
    ...
    let floodsub_topic = libp2p::floodsub::TopicBuilder::new(MAIN_TOPIC).build();
    ...
    let addr = libp2p::Swarm::listen_on(&mut swarm, "/ip4/0.0.0.0/tcp/8000".parse().unwrap()).unwrap();
